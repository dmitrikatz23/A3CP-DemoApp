...
# Repository details
dataset_repo_name = "dk23/A3CP_actions"  # Dataset repo for CSV files
...
if st.button("Train Model") and selected_csvs:
    ...
    # Normalize hand joint positions (adjust these indices if needed)
    ...
    # Compute class weights to handle any imbalance in classes
    ...
    # Generate a timestamped filename for saving the model and label encoder
    ...
    # Save model and label encoder locally
